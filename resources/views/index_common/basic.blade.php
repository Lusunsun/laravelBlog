...
<div id="thumbs">
    <a href="{{ asset('/index/style/images/art/bg1.jpg') }}">1</a>
    <a href="{{ asset('/index/style/images/art/bg2.jpg') }}">2</a>
    <a href="{{ asset('/index/style/images/art/bg3.jpg') }}">3</a>
    <a href="{{ asset('/index/style/images/art/bg4.jpg') }}">4</a>
    <a href="{{ asset('/index/style/images/art/bg5.jpg') }}">5</a>
    <a href="{{ asset('/index/style/images/art/bg6.jpg') }}">6</a>
</div>
<div id="superbgimage">
